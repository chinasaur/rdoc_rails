...
You may then want to rename the directory +vendor/plugins/rdoc_rails.git/+ to
just +rdoc_rails+.

After that, you should be good to go.  The standard +rake doc:app+ or
+rake doc:reapp+ should now run the Rails customized RDoc commands.